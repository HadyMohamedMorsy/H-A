<!-- Header -->
    <div class="header-pages-Product">
    </div>
<!-- header -->
<div class="container-fluid Secound-Section animation-scroll">
        <div class="icones-filter">
          ...
          <div class=" shop-views list-1 small-1">
							<button id="shop-display-grid" class="shop-display grid-icon active" data-display=".grid" onclick="changeclass(this)" >
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
              </button>
							<button id="shop-display-small" class="shop-display small-icon" data-display=".small" onclick="changeclass(this)">
