...
<aside>
    ...
    <ul class="list-of-dashbored">
        ...
        if ($_SESSION['HA_U_P_Category_Manager'] == 'Available') {
            echo '<li><a href="Add-Category.php" class="Add Catogry"><i class="fas fa-briefcase"></i>Add Category</a></li>';
        }
        ?>
        <?php 
        if ($_SESSION['HA_U_P_Category_List'] == 'Available') {
            echo '<li><a href="Category-List.php" class="All-Catagry"><i class="fas fa-briefcase"></i>Category List</a></li>';
        }
        ?>
