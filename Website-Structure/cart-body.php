        ...
        <div class="list">
            <div class="content-parent row">
                ...
                <div class="cheackout-prent col-lg-5">
                    <form class="payment">
                        <div class="total"><h2>Cart totals</h2></div>
                        <div class="total">
                            <h2> substotal </h2>
                            <span> $117.00 </span>
                        </div>
                        <div class="shipping">
                            <div>
                              <input type="radio" id="Free shipping" name="fav_language" value="Free shipping">
                              <label for="html">Free shipping</label>
                            </div>
                            <div>
                              <input type="radio" id="Flat Rate" name="fav_language" value="Flat Rate">
