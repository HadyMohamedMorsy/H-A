        ...
        <div class="right-con">
            <div>
                ...
                <div class="right-con-form">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Number ID</label>
                        <input type="Text" class="form-control" id="exampleInputPassword1" placeholder="Number ID">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Commercial Registration No</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Commercial Registration No">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Brand">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
                                ...
                                <option value="Markting Manger">Markting Manger</option>
                                <option value="Manger Area">Manger Area</option>
                                <option value="Manger Area">Other</option>
                            </select>
                    </div>
                    <div class="form-group">
                    <label for="upload-photo" class="label form-control"> Upload Your Image Person...</label>
                        <input type="file" name="photo" id="upload-photo" />
                    </div>
                    <div class="form-group">
                    <label for="upload-photo" class="label form-control"> Upload Your Image Brand...</label>
                        <input type="file" name="photo" id="upload-photo" />
                    </div>

                </div>
                <button type="submit" name="BTN_Register" class="btn btn-primary">Edit Prfole Seller</button>
            </div>
        </div>
    </form>
</div>
